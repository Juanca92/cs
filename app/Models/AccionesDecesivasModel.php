...
class AccionesDecesivasModel extends Database
{
    ...
    // Crud enfermedad
    public function accionesDecesivas($accion, $datos, $condicion = null, $busqueda = null)
    {

        $builder = $this->db->table("acciones_decesivas");
