...
use App\Models\HistorialOdontologoModel;

class HistorialOdontologo extends BaseController
{
    public $model = null;
    public $fecha = null;
    ...
    {
        parent::__construct();
        $this->model = new HistorialOdontologoModel();
    ...
    public function index()
    {
        ...
        return $this->templater->view("historialOdontologo/index", $this->data);
    }
