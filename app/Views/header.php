...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-light-navy elevation-4">
        ...
        <a href="/" class="brand-link navbar-navy elevation-4">
            <img src="<?php echo base_url('img/diente-logo.jpg') ?>" alt="Logo San Pedro" class="brand-image img-circle elevation-3" style="opacity: 0.9" />
            <span class="brand-text font-weight-light text-white">C.S. | SAN PEDRO</span>
        </a>
