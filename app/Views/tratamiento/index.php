                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <input type="radio" name="tomando_medicamentos" value="si">
                                                                    <label for="tomando_medicamentos">No</label>
                                                                    <input type="radio" name="tomando_medicamentos" value="no">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea type="text" id="porque_tiempo" name="porque_tiempo" class="form-control" style="overflow:auto;resize:none" rows="2" placeholder="escriba aqui"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                ...
                                <div class="card ">
                                    <div class="card-header p-2">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="#recomendaciones" data-toggle="tab">Medicacion y Recomendaciones</a></li>
