                        ...
                        <div class="tab-content">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label for="subjetivo">Subjetivo<span
                                                                        class="text-danger">(*)</span>:</label>
                                                                <textarea type="text" id="subjetivo" name="subjetivo"
                                                                    class="form-control"
                                                                    style="overflow:auto;resize:none" rows="2"
                                                                    placeholder="escriba aqui"></textarea>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label for="objetivo">Objetivo<span
                                                                        class="text-danger">(*)</span>:</label>
                                                                <textarea type="text" id="objetivo" name="objetivo"
                                                                    class="form-control"
                                                                    style="overflow:auto;resize:none" rows="2"
                                                                    placeholder="escriba aqui"></textarea>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label for="analisis">Analisis<span
                                                                        class="text-danger">(*)</span>:</label>
                                                                <textarea type="text" id="analisis" name="analisis"
                                                                    class="form-control"
                                                                    style="overflow:auto;resize:none" rows="2"
                                                                    placeholder="escriba aqui"></textarea>
                                                            </div>
                                                            <input type="hidden" name="id_persona10" id="id_persona10">
                                                            <input type="hidden" name="id_acciones_decesivas"
                                                                id="id_acciones_decesivas">
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                            ...
                            <div class="tab-pane" id="historia_clinica">
                                ...
                                <section class="content">
                                    <div class="container-fluid">
                                        <center>
                                            <button type="button" class="btn btn-default btn-sm mr-auto"
                                                id="daterange-btn">
...
<div class="modal fade" id="modal_imprimir_historia_clinica" tabindex="-1" role="dialog"
